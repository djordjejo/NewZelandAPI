...
namespace NewZelandAPI.Migrations
{
    /// <inheritdoc />
    public partial class Firstseed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0ffb445f-5a34-4d47-af67-a009f0915ab8"), "Hard" },
                    { new Guid("1834a84b-d908-4d30-b95d-9b5503d375c9"), "Medium" },
                    { new Guid("dc9a968e-c974-469c-964e-8fbd87314a14"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("0ffb445f-5a34-4d47-af67-a009f0915ab8"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("1834a84b-d908-4d30-b95d-9b5503d375c9"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("dc9a968e-c974-469c-964e-8fbd87314a14"));
